...
const notInFirstArray = (forbiddenValues, arr) => {
  ...
  return arr.filter(index =>{
    return forbiddenValues.indexOf(index)===-1})
...
const getCharactersWithoutChildren = (arr) => {
  // return an array of all character without children
//test will be length of children array
return arr.filter(index => {
