...
//message is the string callback is the greeting function
...
const addNumbers = (num, arr, times, addValues) => {
  // Solution code here...
  for(let i =0; i < times; i++){ //times is the amount of times num will be added to array
    addValues(arr,num);//is the callback and should push num onto arr
  }
  return arr;
}
